...
// API: Serve consolidated songs by filename
...
app.listen(PORT, () => {
  ...
  console.log('CONSOLIDATED MUSIC SERVER');
  console.log('='.repeat(50));
  console.log('API Endpoints:');
  console.log('- GET /playlists - Get all playlists with song counts');
  console.log('- GET /all-songs - Get all unique songs');
  ...
  console.log('- GET /songs/:filename - Stream song by filename');
